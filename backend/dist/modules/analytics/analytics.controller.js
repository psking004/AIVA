...
let AnalyticsController = class AnalyticsController {
    ...
    async getActivity(auth, days) {
        const userId = this.extractUserId(auth);
        return this.analyticsService.getActivitySummary(userId, parseInt(days) || 7);
    }
    async getProductivity(auth, start, end) {
        const userId = this.extractUserId(auth);
        return this.analyticsService.getProductivityStats(userId, new Date(start), new Date(end));
    }
    extractUserId(auth) {
        return 'user-id';
    }
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AnalyticsController.prototype, "getActivity", null);
__decorate([
