...
const voice_pipeline_service_1 = require("./voice-pipeline.service");
let VoiceModule = class VoiceModule {
};
exports.VoiceModule = VoiceModule;
exports.VoiceModule = VoiceModule = __decorate([
    (0, common_1.Module)({
        providers: [voice_pipeline_service_1.VoicePipelineService],
        exports: [voice_pipeline_service_1.VoicePipelineService],
    })
], VoiceModule);
