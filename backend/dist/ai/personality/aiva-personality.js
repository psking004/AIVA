...
exports.AIVA_SYSTEM_PROMPT = exports.AIVA_PERSONALITY = void 0;
exports.buildPersonalizedPrompt = buildPersonalizedPrompt;
exports.AIVA_PERSONALITY = {
    name: 'AIVA',
...
exports.AIVA_SYSTEM_PROMPT = `You are AIVA (Artificial Intelligent Virtual Assistant), the central AI brain of a Personal AI Operating System.
 ...
 */
function buildPersonalizedPrompt(userName, preferences) {
    let prompt = exports.AIVA_SYSTEM_PROMPT;
    if (userName) {
...
//# sourceMappingURL=aiva-personality.js.map